...
class _HomeScreenState extends State<HomeScreen> {
  List<PickedFile> images = []; //Arreglo que contendra nuestras imagenes
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                  GestureDetector( //Definimos el menu
  ...
  void _openCamera() async {
    PickedFile picture = await imagePicker.getImage( //el metodo get recibe la ruta y muestra la cammara osea el path
      source: ImageSource.camera,
    );
    Navigator.pop(context);
    setState(() {
      images.add(picture); //Reincia la interfaz de la aplicacion para que ya muestre las imagenes
    });
  }
